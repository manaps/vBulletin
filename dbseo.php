...
// as most requests now funnel here, we need to manually include our composer dependencies
require_once(__DIR__ . '/vendor/autoload.php');

// also handle our dotenv stuff here
...
if (!$_gotUrl)
{
	...
	if (
		...
		AND strpos($_GET['redirect'], 'http') === 0
	)
	{
		// The redirect parameter will be sanitised in the init_startup hook
		$_GET['do'] = $_REQUEST['do'] = 'page';
		$_GET['template'] = $_REQUEST['template'] = 'dbtech_dbseo_redirect';
		require('misc.php');
		die();
	}
