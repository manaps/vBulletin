...
if ($_REQUEST['do'] == 'head')
{
	...
	<tr align="center" valign="top">
		<td style="text-align:<?php echo $stylevar['left']; ?>"><a href="https://www.dragonbyte-tech.com/" target="_blank"><b><?php echo $vbphrase['admin_control_panel']; ?></b> (DragonByte Tech: DragonByte SEO v2.0.42)</a></td>
		<td><a href="https://www.dragonbyte-tech.com/" id="head_version_link" target="_blank">&nbsp;</a></td>
