...
class vB_Upgrade_Ajax extends vB_Upgrade_Abstract
{
	...
	*/
	...
	{
		parent::init();
		$this->custnumber = (strlen('0c5b31015fcf1c28a3a7bcd17681bd67') == 32) ? '0c5b31015fcf1c28a3a7bcd17681bd67' : md5(strtoupper('0c5b31015fcf1c28a3a7bcd17681bd67'));
...
/*======================================================================*\
|| ####################################################################
|| # Downloaded: 17:39, Sat Aug 3rd 2019 : $Revision: 92252 $
