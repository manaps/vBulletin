...
* @ignore
*/
define('COOKIE_SALT', 'YkudxxaqkT0IWwGffuj7FTMmfRj1X4rM6');
...
function verify_ip_ban()
{
	...
	if (defined('THIS_SCRIPT') && THIS_SCRIPT == 'sendmessage' AND (empty($_REQUEST['do']) OR $_REQUEST['do'] == 'contactus' OR $_REQUEST['do'] == 'docontactus'))
	{
		return;
	}
...
function cache_permissions(&$user, $getforumpermissions = true, $resetaccess = false, $calperms = true)
{
	...
	if (defined('THIS_SCRIPT') && (!empty($calfiles[THIS_SCRIPT]) AND $calperms))
	{
...
/*======================================================================*\
|| ####################################################################
|| # Downloaded: 17:39, Sat Aug 3rd 2019 : $Revision: 93880 $
