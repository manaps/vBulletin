...
class vB_Blog_EntryFactory
{
	...
	*/
	function __construct(&$registry, &$bbcode, &$categories)
	{
...
class vB_Blog_Entry
{
	...
	*/
	function __construct(&$registry, &$factory, &$bbcode, &$categories, $blog, $ignored_users)
	{
	...
	*/
	function prepare_end()
	{
		...
		if (!($this->registry->options['logip'] AND $this->blog['blogipaddress'] 
		AND (can_moderate_blog('canviewips') OR $this->registry->options['logip'] == 2)))
		{
