...
function &fetch_blog_list($blogids, $attachcount, &$postattach, &$categories, $sqljoin = null, $wheresql = null, $deljoinsql = null, $orderby = "blog.dateline DESC")
{
	...
	$blogs = $vbulletin->db->query_read("
		SELECT
			...
			blog_text.pagetext, ipdata.ip AS blogipaddress, blog_text.allowsmilie, blog_text.htmlstate,
			user.*,
...
/*======================================================================*\
|| ####################################################################
|| # Downloaded: 17:39, Sat Aug 3rd 2019 : $Revision: 92589 $
|| # $Date: 2017-01-23 18:27:53 -0800 (Mon, 23 Jan 2017) $
|| ####################################################################
\*======================================================================*/
?>
