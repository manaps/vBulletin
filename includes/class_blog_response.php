...
class vB_Blog_ResponseFactory
{
	...
	*/
	function __construct(&$registry, &$bbcode, &$bloginfo)
	{
...
class vB_Blog_Response
{
	...
	*/
	function __construct(&$registry, &$factory, &$bbcode, $bloginfo, $response)
	{
	...
	*/
	function prepare_end()
	{
		...
		if (!($this->registry->options['logip'] AND $this->response['blogipaddress'] 
