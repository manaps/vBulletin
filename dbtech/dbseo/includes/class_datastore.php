...
*/
class DBSEO_Datastore_Memcached extends DBSEO_Datastore_Memcache
{
	public function __construct()
	{
		if (!class_exists('Memcache', false))
		{
			trigger_error('The Memcache<b>d</b> class is no longer supported, please update your config to use Memcache or install another cache provider.', E_USER_ERROR);
		}
...
*/
class DBSEO_Datastore_Memcache extends DBSEO_Datastore
{
	/**
	* The Memcache object
	*
