...
*/
class DBSEO_Rewrite_MemberList_Page extends DBSEO_Rewrite_MemberList
{
	public static $format = 'MemberList_MemberList_Page';
	public static $structure = 'memberlist.php?page=%d';
