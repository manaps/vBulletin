...
// #############################################################################
// DBSEO "MemberProfile URL" class

/**
* Lets you construct & lookup custom URLs
*/
class DBSEO_Rewrite_MemberProfile
{
	public static $format = 'MemberProfile_MemberProfile';
	public static $structure = 'member.php?u=%d%s';
	...
	public static function resolveUrl($urlInfo = array(), $structure = NULL)
	{
		...
		return sprintf((is_null($structure) ? self::$structure : $structure), $urlInfo['user_id'], (isset($_GET['tab']) ? '&tab=' . $_GET['tab'] : ''));
	}
