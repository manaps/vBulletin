...
*/
class DBSEO_Rewrite_VisitorMessage_Conversation_Page extends DBSEO_Rewrite_VisitorMessage_Conversation
{
	public static $format = 'MemberProfile_VisitorMessage_Conversation_Page';
	public static $structure = 'converse.php?u=%d&u2=%d&page=%d';
