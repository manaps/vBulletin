...
// #############################################################################
// DBSEO "VisitorMessage URL" class

/**
* Lets you construct & lookup custom URLs
*/
class DBSEO_Rewrite_VisitorMessage_Page
{
	public static $format = 'MemberProfile_VisitorMessage_Page';
	public static $structure = 'member.php?u=%d&tab=visitor_messaging&page=%d';
