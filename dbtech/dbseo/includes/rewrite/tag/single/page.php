...
*/
class DBSEO_Rewrite_Tag_Single_Page extends DBSEO_Rewrite_Tag_Single
{
	public static $format = 'Tags_Tag_Single_Page';
	public static $structure = 'tags.php?tag=%s&page=%d';
