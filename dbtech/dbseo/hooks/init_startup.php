...
do
{
	...
	)
	{
		...
		{
			vB_Template::preRegister('custom_dbtech_dbseo_redirect', array('_dbseoRedirect' => htmlspecialchars_uni($_GET['redirect'])));
		}
		else
		{
			$_dbseoRedirect = htmlspecialchars_uni($_GET['redirect']);
		}
	}
