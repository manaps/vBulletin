...
function print_line_chart($labels, $datasets, $isBytes = false)
{
	...
	if (!isset($GLOBALS['_vboptimise_included_chartjs']))
	{
		?>
		<script type="text/javascript" src="../dbtech/vboptimise/clientscript/3rdparty/chart/Chart.min.js"></script>
		<script type="text/javascript" src="../dbtech/vboptimise/clientscript/3rdparty/chart/Chart.Helper.js"></script>
		<?php
		$GLOBALS['_vboptimise_included_chartjs'] = true;
	}
